...
# a criarem métodos concretos. Também podem ter métodos
# concretos por elas mesmas.
# @abstractmethods são métodos que não tem corpo.
# As regras para classes abstratas com métodos abstratos
# é que elas NÃO PODEM ser instanciadas diretamente.
# Métodos abstratos DEVEM ser implementados nas
...
# use @abstractmethos como decorator mais interno.
